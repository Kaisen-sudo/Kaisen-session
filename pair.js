...
router.get('/', async (req, res) => {
    ...
    async function KAISEN_PAIR_CODE() {
            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'KAISEN-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features KAISEN-MD.
2️⃣ Stay updated with our latest releases and support.
3️⃣ Enjoy seamless WhatsApp automation! 🤖  

🔗 *Join Our Support Channel:* 👉 [Click Here to Join](https://whatsapp.com/channel/0029Vb6D62l1dAw1qVnKgu3y) 

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [Kaisen GitHub Repo](https://github.com/Kaisen-sudo/)  

🚀 _Thanks for choosing KAISEN-MD— Let the automation begin!_ ✨`;

                    await Malvin.sendMessage(Kaisen.user.id, { text: KAISEN_TEXT }, { quoted: session });
